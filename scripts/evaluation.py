...
# 1. Fonction pour calculer les métriques de performance
def calculate_metrics(data):
    # Calculer les métriques pour le genre
    ...
    # Calculer les métriques pour la date d'accident
    ...
    # Calculer les métriques pour la date de consolidation
